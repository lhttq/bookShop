    ...
    <script>
        $(function () {
            $("#btn01").click(function () {
                ...
                %>
                $.ajax({
                    url:"../bsCarts/InsertBsCart",
                    contentType:"application/json;charset=UTF-8",
                    data:'{"bsUserid":<%=userId%>,"bsIscheck":"1","bsGoodsid":"${bsBooks.bsBookid}","bsCartnum":"1"}',
                    dataType:"json",
                    type:"post",
...
<div class="body" >
    ...
    <div class="context">
        <div class="card">
            <img src="${bsBooks.bsBookcover}" alt="Avatar" style="width:100%">
            <div class="container">
                <h4><b>${bsBooks.bsBookname}</b></h4>
            </div>
        </div>
        <div class="infrom">
            <p class = "font">价格：${bsBooks.bsBookprice} </p>
            <p class="font">优惠价：</p>
            <p><span>配送至:</span>
            ...
            <button id="btn01" class="layui-btn layui-btn-lg layui-btn-normal">加入购物车</button>
        </div>
        <div class="show">
            <div class="layui-tab">
